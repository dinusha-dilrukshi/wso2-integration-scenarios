...
<%@ page import="java.util.*" %>
  <%@ page import="org.wso2.carbon.identity.cloud.sample.JWTProcessor" %>
  <%@ page import="org.wso2.carbon.identity.cloud.sample.TokenManager" %>
  <%@page import="org.apache.commons.logging.LogFactory"%>
  <%@ page import="org.apache.commons.logging.Log" %>
  <%@ page import="org.wso2.carbon.identity.cloud.sample.DestinationManager" %>
  <%! static final Log log = LogFactory.getLog(index_jsp.class); %>
  <%
	String userName = "sub";
	String telePhone = "http://wso2.org/claims/telephone";
	String streetAddress = "http://wso2.org/claims/streetaddress";
	String ffId ="http://wso2.org/claims/ffid";
    ...
    if(header !=null && !header.equals("")){
        ...
        String accessToken = tokenManager.getToken(header);
    ...
    if(routeMap.get(headerMap.get(userName)) != null) {
        ...
        String userStoreDomain = "IS-WSO2.COM/";
        if (username.startsWith(userStoreDomain)) {
            username = username.substring(userStoreDomain.length() , username.length());
        }
        route = routeMap.get(username);
    }else{
        //Call API to get routeNo
        route = destinationManager.getRouteNumber(accessToken);
      ...
      <div class="row marketing">
        ...
        <div class="col-lg-3">
          ...
          <p><%
              ...
              }else if (headerMap!=null && headerMap.get(streetAddress) != null){
        ...
        <div class="col-lg-3">
          ...
          <p><%
              ...
              }else if (headerMap!=null && headerMap.get(ffId) != null){
        ...
        <div class="col-lg-2">
          ...
          <p><%
              ...
              }else if(headerMap!=null && headerMap.get(telePhone) != null){
